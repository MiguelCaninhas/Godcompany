<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_mestre_admin.Master" AutoEventWireup="true" CodeBehind="Consultar_hoteis.aspx.cs" Inherits="Godcompany.Consultar_hoteis" %>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 style="color:#40E0D0; ">Ver reservas de hoteis</h2>
    ...
    <div style="margin-left:75px">
      ...
      <h1 style="color:white" > <label for="inputEmail3" class=" col-form-label" > . </label></h1>
			...
			<div class="row">
				...
				<asp:DataList ID="dl_consulta_hoteis" Style="width: 100%;" runat="server" OnItemDataBound="dl_consulta_hoteis_ItemDataBound" RepeatLayout="Flow" RepeatDirection="Horizontal" OnItemCommand="dl_consulta_hoteis_ItemCommand" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" OnSelectedIndexChanged="dl_consulta_hoteis_SelectedIndexChanged">
                    <ItemTemplate>
					<asp:Panel ID="Mostrar_hoteis" runat="server">
		...
		<h1 style="margin-left:2%; font-size:xx-large; color:black "><asp:Label ID="Label4" runat="server" Text="Não existe hoteis reservados"></asp:Label></h1>
