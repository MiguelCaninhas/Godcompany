<%@ Page Title="" Language="C#" MasterPageFile="~/mestrer_comprar.Master" AutoEventWireup="true" CodeBehind="comprar_tudo.aspx.cs" Inherits="Godcompany.comprar_tudo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 style="color:#40E0D0; ">Melhores pacotes de viagens</h2>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							...
							<asp:Label ID="id_pack" runat="server" ForeColor="Turquoise" Visible ="false"></asp:Label>
                            <asp:Label ID="Nome_pack" runat="server" ForeColor="Turquoise" Font-Size="X-Large"></asp:Label>
							<p style="align-items:center"><asp:Label ID="Label1" runat="server" ForeColor="Black" Text ="Hotel: "></asp:Label><asp:Label ID="Nome_hotel" runat="server" ></asp:Label></p>
							<p style="align-items:center"><asp:Label ID="Label2" runat="server" ForeColor="Black" Text="Voos: "></asp:Label><asp:Label ID="Nome_voo" runat="server" ></asp:Label></p>
							<p style="align-items:center"><asp:Label ID="Label3" runat="server" ForeColor="Black" Text ="Atividades: "></asp:Label><asp:Label ID="Nome_atividade" runat="server" ></asp:Label></p>
	...
	<asp:Panel ID="mostrar_nada" runat="server" Visible ="false">
		...
		<h1 style="margin-left:35%; font-size:xx-large "><asp:Label ID="Label4" runat="server" Text="Não existe packs disponiveis"></asp:Label></h1>
