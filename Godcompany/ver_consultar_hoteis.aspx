<%@ Page Title="" Language="C#" MasterPageFile="~/Pagina_mestre_admin.Master" AutoEventWireup="true" CodeBehind="ver_consultar_hoteis.aspx.cs" Inherits="Godcompany.ver_consultar_hoteis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div style="display: inline-flex; padding: 10px;">
    ...
    <h2 style="color:black; margin-left:0%;  font-size:x-large"> <label for="inputEmail3" class=" col-form-label" >Nome hotel:</label></h2>
...
<%--    <h1 style="color:black"> <label for="inputEmail3" class=" col-form-label" >Numero de Adultos:</label></h1>
    ...
    <asp:TextBox ID="dia_chegada" runat="server" class="form-control col-sm-9"  BorderStyle ="Solid"  placeholder="Numero" Font-Size="Medium" Width="60%" BackColor="White" ReadOnly="True" ></asp:TextBox>
     </div>
	    ...
	    <h1 style="color:white" > <label for="inputEmail3" class=" col-form-label" > . </label></h1>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
                            ...
                            <p style="align-items:center"><asp:Label ID="Label1" runat="server" ForeColor="Black" Text="Preço: " ></asp:Label><asp:Label ID="preco_quarto" runat="server" ></asp:Label></p>
